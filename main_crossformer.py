...
parser.add_argument('--attn', type=str, default='prob', help='FuLL or Drop')
...
for ii in range(args.itr):
    ...
    setting = 'Crossformer_{}_il{}_ol{}_sl{}_win{}_attn{}_fa{}_dm{}_nh{}_el{}_itr{}_experts{}_top_k{}'.format(args.data, 
                args.in_len, args.out_len, args.seg_len, args.win_size, args.attn, args.factor,
                args.d_model, args.n_heads, args.e_layers, ii, args.num_experts, args.top_k)
